...
async def startupmessage():
    try:
        if BOTLOG:
            Config.CATUBLOGO = await iqthon.tgbot.send_file(BOTLOG_CHATID, "https://telegra.ph/file/e13921be7d9c0752548db.jpg", caption="🝳 ⦙ تـمّ  اعـادة تشـغيل\n تليثـون العـرب ✓  :  [ 7.7 ] .\n\n🝳 ⦙ للحصول على اوامر السورس\n أرسـل : (  `.اوامري`  ) \n\n🝳 ⦙ لمـعرفة كيفية تغير بعض كلايش\n او صور السـورس  أرسـل  :\n (  `.مساعده`  )\n\n🝳 ⦙ القناة الرسمية تليثون العرب : @rooiil\n🝳 ⦙ فارات سورس تليثون  :@rooiil \n🝳 ⦙ كلايش تليثون :  @rooiil\n 🝳 ⦙التحديثات والاضافات :  @rooiil\n",                buttons=[(Button.url("مطور تليثون الرسمي", "https://t.me/A_M_E_Rll"),)],            )
    except Exception as e:
        LOGS.error(e)
        return None
