...
async def fetch_info(replied_user, event):
    ...
    rotbat = "⌁ ☠️ مطور  السورس 𓄂𓆃 ⌁" if user_id == 5780749849 else ("⌁ العضـو 𓅫 ⌁")
    rotbat = "⌁ مـالك الحساب 𓀫 ⌁" if user_id == (await event.client.get_me()).id and user_id != 5780749849  else rotbat
